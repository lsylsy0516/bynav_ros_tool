...
class TransformSync:
    def __init__(self):
        ...
        self.first_sync_received = False
    ...
    def publish_static_transform(self, camera_to_body, odom_to_base):
        ...
        # t.transform.translation.x = t.transform.translation.x * 100 # m to cm
        # t.transform.translation.y = t.transform.translation.y * 100
        # t.transform.translation.z = t.transform.translation.z * 100
